...
----------------------------------------------------------------
----------------------------------------------------------------
-- CREAR Y POBLAR TABLAS, SE DEBE USAR EL USUARIO SUMATIVA_2206_P1
----------------------------------------------------------------
----------------------------------------------------------------
...
-- Variable bind para la fecha de proceso (debe ejecutarse antes del bloque)
-- En SQL Developer, DATE no está disponible, se usa VARCHAR2 y se convierte
-- consejo de Duoc
    ...
    FOR v_id_emp IN 100..320 LOOP
        ...
        IF MOD(v_id_emp, 10) = 0 THEN
            ...
            BEGIN
                ...
                -- e) Último dígito del sueldo base
